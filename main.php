<?php 
	...
	if(isset($_POST['add_que']))
	{
		...
		$u_id=$_SESSION['login'];
		$ins_que="INSERT INTO questions (u_id,q_content) VALUES ('$u_id','$content')";
		mysqli_query($conn,$ins_que);
	}
?>
<!DOCTYPE html>
<html>
			  ...
			  <div class="collapse navbar-collapse nav-tabs" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto " style="padding-right:30px;">
				  <li class="nav-item active" style="padding-right:40px; padding-left:20px;">
					<a class="nav-link" href="#"><h3><strong style="color:#0086b3;">HOME </strong></h3><span class="sr-only">(current)</span></a>
				  </li>
											...
											<div class="col-md-12">
												<form method="POST"> 
													<div class="form-group">
														<textarea class="form-control" id="content" rows="1" placeholder="Start your question with What , When , Why" required></textarea>
													 </div><br>
													 <div class="form-group">
														<div id="add_err2"></div>
														<button type="submit" id="add_que" class="btn btn-info btn-lg btn-block" >Add</button>
													 </div>
												</form>
											</div>
										</div>
