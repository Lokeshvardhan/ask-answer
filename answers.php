					...
					echo"
								...
								<br>
									...
									<div class='row'>
										...
										<a type='button' class='btn btn-info' data-toggle='modal' href='#staticBackdrop' style='font-size:15px; border-radius:7px;'>Type the Answer</a></div>
								</div>
								<div>
										<!-- Modal -->
															...
															<div class='col-md-12'>
																<form method='POST'> 
																	<div class='form-group'>
																	 ...
																	 <div class='form-group'>
																	 ";?>
																		<button type='submit' id='add_ans' onclick="question_id(<?php echo $rows['q_id']?>)" class='btn btn-info btn-lg btn-block' >Submit</button>
																	<?php echo"
																	 </div>
																</form>
															</div>
